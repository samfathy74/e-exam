<%@ Page Title="Create Questions 📑" Language="C#" MasterPageFile="~/_MainLayout.master" AutoEventWireup="true" CodeFile="ExamCreator.aspx.cs" Inherits="ExamCreator" %>
                    ...
                    <table class="auto-style15 form-group">
                        ...
                        <tr>
                            ...
                            <th class="auto-style14">
                                <asp:Button ID="tbnNextQuestion" runat="server" CssClass="btn btn-danger btn-radius" OnClick="tbnNextQuestion_Click" style="left: 1%; top: 0px" Text="NEXT QUESTION" ToolTip="Go To Next Question" ValidationGroup="Exam" />
                            </th>
                        </tr>
                    </table>
