...
We are the E-exam community. We wish you all the best. All you know is that you study hard so that you can succeed in our exams and get the highest results.<br />
    ...
    <div class="WelcomBtn">
     <asp:Button ID="ButtonStatistics" runat="server" CssClass="btn-dark btn-lg btn-sm" Text="Statistics" ForeColor="White" Font-Names="Segoe UI" Font-Size="Medium" PostBackUrl="~/StudentStatistic.aspx"  />
    </div>
