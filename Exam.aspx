<%@ Page Title="" Language="C#" MasterPageFile="~/_MainLayout.master" AutoEventWireup="true" CodeFile="Exam.aspx.cs" Inherits="Exam" %>
...
<asp:Content  ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <br /><br />
        ...
        <ItemTemplate>
            ...
            <div class="Label-NOofQuestion center-block">
                <asp:Label ID="LabelNoQuestion" runat="server" Font-Bold="True" Font-Names="Eras Demi ITC" Font-Size="20px">Quetion (<%# Container.ItemIndex + 1 %>)</asp:Label>
            </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
            <ContentTemplate>
    <asp:Button ID="ButtonFinish" runat="server" CssClass="btn btn-success btn-lg center-block"  Text="Finish" OnClick="ButtonFinish_Click" OnClientClick="javascript:var win = window.open('Results.aspx','_blank');window.close();window.onbeforeunload=null;" />
                </ContentTemplate>
        </asp:UpdatePanel>
     <script>
